...
class get_ijwd:
    ...
    def generate_d_rand_lowerHigherBound(self):
        '''synaptic delay uniformly distributed between self.delay[0] to self.delay[1]
            self.delay is an 1-D array containing 2 scalar'''
        self.d_ee = np.random.uniform(self.delay[0], self.delay[1], len(self.i_ee))
        self.d_ie = np.random.uniform(self.delay[0], self.delay[1], len(self.i_ie))
        self.d_ei = np.random.uniform(self.delay[0], self.delay[1], len(self.i_ei))
        self.d_ii = np.random.uniform(self.delay[0], self.delay[1], len(self.i_ii))
