...
% sys_argv = str2double(varargin{1});
%%
% rng(sys_argv)
...
% title_fig = sprintf('modufr%d-pk%d-gausig%d-base%d-gam%d-rad%d-dep%d-%d', ifmodu_fr, peak, sig, fr_base, p.gam, p.radius(1), p.depth(1),sys_argv);
...
save([savedatapath,'data_fano_corr_',num2str(sys_argv),'.mat'], 'p')
...
% end
% 
% moviname = sprintf('fano_%s.avi', title_fig);
% 
