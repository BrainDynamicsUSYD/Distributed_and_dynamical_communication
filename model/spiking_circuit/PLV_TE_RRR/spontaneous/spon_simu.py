# -*- coding: utf-8 -*-
"""
Created on Wed Apr 10 17:27:13 2024
...
'''
Simulation for spontaneous activity
'''
...
simu_time_tot = 205*second

net.run(simu_time_tot, profile=False) #,namespace={'tau_k': 80*ms}
