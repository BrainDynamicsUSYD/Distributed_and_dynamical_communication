# -*- coding: utf-8 -*-
"""
Created on Mon Apr  8 17:56:06 2024
...
repeat = 60 # the number of total random realizations of the network;
...
num_trials = 50 # number of trials for each condition (i.e., uncued/cued)
